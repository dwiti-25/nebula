...
\begin{description}
  ...
  \item[Interface completeness.] The current source tree contains a structured
  web UI but not the LLM wrapper described in presentation material. The bonus
  deliverable should not be claimed unless its source, tests, and runnable entry
  point are included.
\end{description}
